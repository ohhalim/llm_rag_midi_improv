"""
LLM API 모듈
LangChain을 활용하여 LLM과 통합하고 MIDI 생성을 위한 프롬프트 처리를 담당합니다.
"""
...
class LLMAPI:
    def __init__(self, model=None, base_url=None):
        ...
        Args:
            model: 사용할 LLM 모델 (기본값: config.py에서 설정)
    ...
    def enhance_solo(self, json_response, min_notes=100):
        ...
        Args:
            json_response: LLM이 생성한 JSON 응답
            min_notes: 최소 노트 수 (기본값: 100)
    ...
    def generate_response(self, input_features, similar_features):
        ...
        Args:
            input_features: 입력 MIDI 특징
            similar_features: 유사한 MIDI 특징
